...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_4.setPlaceholderText(_translate("MainWindow", "search on ID"))
        ...
        match index:
            case 0:
                ...
                if(item is not None and item.text() != ''):
                    ...
                    estate.delete(item.text())
                    self.tableWidget_2.removeRow(self.tableWidget_2.currentRow())
            case 1:
                item = self.tableWidget_3.item(self.tableWidget_3.currentRow(), 0)
                if(item is not None and item.text() != ''):
                    customer = queries.Customer()
                    customer.delete(item.text())
