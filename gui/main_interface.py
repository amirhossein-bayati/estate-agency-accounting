...
from loginDialog import Ui_loginDialog as loginDialog
...
"}")
        ...
        self.newBtn_2.clicked.connect(lambda: self.open_dialog(0))
        self.newBtn_3.clicked.connect(lambda: self.open_dialog(1))
    ...
    def open_dialog(self, Index):
        ...
        dialog.ui.stackedWidget.setCurrentIndex(Index)
        dialog.exec_()
        dialog.show()
        self.loadData()
    ...
    def loadData(self):
        ...
        for row in estate:
            ...
            self.tableWidget_2.setItem(tableRow, 6, QtWidgets.QTableWidgetItem(str(row.number_of_bedrooms)))
            self.tableWidget_2.setItem(tableRow, 7, QtWidgets.QTableWidgetItem(str(row.number_of_bathrooms)))
            self.tableWidget_2.setItem(tableRow, 8, QtWidgets.QTableWidgetItem(str(row.number_of_parking)))
            self.tableWidget_2.setItem(tableRow, 9, QtWidgets.QTableWidgetItem(str(row.floor)))
            self.tableWidget_2.setItem(tableRow, 10, QtWidgets.QTableWidgetItem(str(row.number_of_floors)))
            self.tableWidget_2.setItem(tableRow, 11, QtWidgets.QTableWidgetItem(str(row.number_of_unit_per_floor)))
            self.tableWidget_2.setItem(tableRow, 12, QtWidgets.QTableWidgetItem(str(row.elevator)))
            self.tableWidget_2.setItem(tableRow, 13, QtWidgets.QTableWidgetItem(str(row.made_year)))
            self.tableWidget_2.setItem(tableRow, 14, QtWidgets.QTableWidgetItem(str(row.description)))
            tableRow+=1

        customer = models.Customer.query.all()
        tableRow = 0
        for row in customer:
            self.tableWidget_3.setItem(tableRow, 0, QtWidgets.QTableWidgetItem(str(row.id)))
            self.tableWidget_3.setItem(tableRow, 1, QtWidgets.QTableWidgetItem(str(row.first_name)))
            self.tableWidget_3.setItem(tableRow, 2, QtWidgets.QTableWidgetItem(str(row.last_name)))
            self.tableWidget_3.setItem(tableRow, 3, QtWidgets.QTableWidgetItem(str(row.identity_card)))
            self.tableWidget_3.setItem(tableRow, 4, QtWidgets.QTableWidgetItem(str(row.mobile)))
            self.tableWidget_3.setItem(tableRow, 5, QtWidgets.QTableWidgetItem(str(row.email)))
            self.tableWidget_3.setItem(tableRow, 6, QtWidgets.QTableWidgetItem(str(row.address)))
            tableRow+=1

        contract = models.Contract.query.all()
        tableRow = 0
        for row in contract:
            self.tableWidget_4.setItem(tableRow, 0, QtWidgets.QTableWidgetItem(str(row.id)))
            self.tableWidget_4.setItem(tableRow, 1, QtWidgets.QTableWidgetItem(str(row.estate_id)))
            self.tableWidget_4.setItem(tableRow, 2, QtWidgets.QTableWidgetItem(str(row.estate)))
            self.tableWidget_4.setItem(tableRow, 3, QtWidgets.QTableWidgetItem(str(row.agent_id)))
            self.tableWidget_4.setItem(tableRow, 4, QtWidgets.QTableWidgetItem(str(row.employee)))
            self.tableWidget_4.setItem(tableRow, 5, QtWidgets.QTableWidgetItem(str(row.buyer)))
            self.tableWidget_4.setItem(tableRow, 6, QtWidgets.QTableWidgetItem(str(row.seller)))
            self.tableWidget_4.setItem(tableRow, 7, QtWidgets.QTableWidgetItem(str(row.contract_type)))
            self.tableWidget_4.setItem(tableRow, 8, QtWidgets.QTableWidgetItem(str(row.payment_amount)))
            self.tableWidget_4.setItem(tableRow, 9, QtWidgets.QTableWidgetItem(str(row.profit)))
            self.tableWidget_4.setItem(tableRow, 10, QtWidgets.QTableWidgetItem(str(row.date_signed)))
            self.tableWidget_4.setItem(tableRow, 11, QtWidgets.QTableWidgetItem(str(row.description)))
            tableRow+=1

        employee = models.Employee.query.all()
        tableRow = 0
        for row in employee:
            self.tableWidget_5.setItem(tableRow, 0, QtWidgets.QTableWidgetItem(str(row.id)))
            # self.tableWidget_5.setItem(tableRow, 1, QtWidgets.QTableWidgetItem(str(row.username)))
            # self.tableWidget_5.setItem(tableRow, 2, QtWidgets.QTableWidgetItem(str(row.password)))
            self.tableWidget_5.setItem(tableRow, 1, QtWidgets.QTableWidgetItem(str(row.first_name)))
            self.tableWidget_5.setItem(tableRow, 2, QtWidgets.QTableWidgetItem(str(row.last_name)))
            self.tableWidget_5.setItem(tableRow, 3, QtWidgets.QTableWidgetItem(str(row.identity_card)))
            self.tableWidget_5.setItem(tableRow, 4, QtWidgets.QTableWidgetItem(str(row.mobile)))
            self.tableWidget_5.setItem(tableRow, 5, QtWidgets.QTableWidgetItem(str(row.email)))
            self.tableWidget_5.setItem(tableRow, 6, QtWidgets.QTableWidgetItem(str(row.position)))
            self.tableWidget_5.setItem(tableRow, 7, QtWidgets.QTableWidgetItem(str(row.salary)))
            self.tableWidget_5.setItem(tableRow, 8, QtWidgets.QTableWidgetItem(str(row.total_sales)))
            tableRow+=1
